    ...
    @if ($posts->count())
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div style="max-height: 450px; overflow:hidden;">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" alt="{{ $posts[0]->category->name }}"
                        class="img-fluid "
                        style="background-repeat: no-repeat !important ;background-size: cover !important; width : 1400px !important; height: 500px !important;">
                </div>
            @else
            ...
            <div class="card-body text-center">
                ...
                <p>
                    <small class="text-muted">By. <a href="/posts?authors={{ $posts[0]->author->username }}"
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p>
                                    <small class="text-muted">By. <a href="/posts?authors={{ $post->author->username }}"
